    ...
    return (
        <div className="relative">
            <div className="flex flex-row items-center gap-3">
                <div className="hidden md:block text:sm font-semibold py-3 px-4 rounded-full hover:bg-neutral-100 transition cursor-pointer" onClick={() => console.log('object')}>
                    Airbnb your home
                </div>
            ...
            {isOpen && (<div className='absolute rounded-xl shadow-md w-[40vw] md:w3/4 bg-white overflow-hidden right-0 top-12 text-sm'>
                <div className='flex flex-col cursor-pointer'>
                    <>
                        <MenuItem label={'Login'} onClick={() => console.log('first')} />
                        <MenuItem label={'Sign Up'} onClick={() => console.log('first')} />
